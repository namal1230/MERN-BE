...
phostsRouter.get("/get-reported-phost",getReportByPhostId)
phostsRouter.get("/remove-report",deactivateReportedPhost)
...
phostsRouter.get("/get-report-email",getReportedPhostById)
