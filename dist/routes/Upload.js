...
uploadRouter.post("/image", Auth_1.default, multer_1.upload.single("image"), UploadController_1.imageUpload);
uploadRouter.post("/video", Auth_1.default, multer_1.upload.single("vedio"), UploadController_1.vedioUpload);
